...
//初始化函数
-(id)initWithAppid:(NSString *)app_id mch_id:(NSString *)mch_id spKey:(NSString *)key
{
    self = [super init];
    if (self) {
        //初始构造函数
                                          ...
                                          device:(NSString *)device
{
    ...
    [packageParams setObject: orderno           forKey:@"out_trade_no"];//商户订单号，自定义，保证订单的唯一性，一般由后台提供
